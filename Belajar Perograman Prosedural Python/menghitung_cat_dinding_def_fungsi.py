...
panjangRuang : float = float(input("Masukkan panjang ruangan rumah : \n"))
lebarRuang   : float = float(input("Masukkan lebar ruangan rumah: \n"))
tinggiRuang  : float = float(input("Masukkan tinggi ruangan rumah: \n"))
